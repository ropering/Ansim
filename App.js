      ...
      <Stack.Navigator screenOptions={{ headerBackTitle: null }}>
        {user ? (
          <>
            ...
            <Stack.Screen name="ShowDetailPost" component={ShowDetailPost} options={{ headerShown: false }}/>
            ...
            <Stack.Screen name="Heart" component={MyHeartList} options={{title: '찜 리스트', headerTitleStyle: styles.headerTitle}}/>
